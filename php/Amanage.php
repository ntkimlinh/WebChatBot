...
<body>
    <div class="container">
        ...
        <div class="AddS">
            <button onclick="location.href='/php/AddStudent.php'" style="border-radius: 10px; width:150px; height:50px;">Thêm Sinh Viên</button>
            <button onclick="location.href='/php/AddAdmin.php'" style="border-radius: 10px; width:150px; height:50px;">Thêm Admin</button>
            <button onclick="location.href='/php/forget.php'" style="border-radius: 10px; width:150px; height:50px;">Đổi mật khẩu</button>
        </div>
        ...
        if ($result->num_rows > 0) {
            ...
            foreach ($rows as $row) {
                ...
                echo "<h2 id='STT'>Tên đăng nhập: <a>" . $row["Sid"] . "</a></h2>";
                echo "<p class='info1'>Mã số sinh viên: <a id='info1'>" . $row["username"] . "</a></p>";
                echo "<p class='info1'>Họ và tên: <a id='info1'>" . $row["SName"] . "</a></p>";
                echo "<p class='info1'>Ngày sinh: <a id='info1'>" . $row["DOB"] . "</a></p>";
                echo "<p class='info1'>Chuyên ngành: <a id='info1'>" . $row["Major"] . "</a></p>";
                echo "<p class='info1'>Lớp: <a id='info1'>" . $row["Class"] . "</a></p>";
                echo "</div>";
                echo "</div>";
            }
        } else {
